...
namespace RoadCrossing
{
	...
	public class RCGGameController : MonoBehaviour
	{
		...
		void Start()
		{
			...
			if (ResourceBoost.Instance.gold == 50)
			{
				ChangeScore(50);
			}
			else {
			...
			if (ResourceBoost.Instance.hp == 1)
			{
			...
			if (ResourceBoost.Instance.goldx2 == 2)
			{
		...
		{
			ResourceBoost.Instance.gold = 0;
			ResourceBoost.Instance.hp = 0;
			ResourceBoost.Instance.goldx2 = 1;
